            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <label class="block">
                            ...
                            <textarea class="form-textarea mt-1 block w-full rounded-md border-gray-300 focus:border-black-50" rows="3" placeholder="Enter some long form content."></textarea>
                        </label>
                        <br>
                        <label class="block">
