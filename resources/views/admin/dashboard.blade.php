...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                ...
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-teal panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-shopping-cart color-blue"></em>
                            ...
                            <div class="text-muted">New Property</div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
        ...
        <script src="/adminassets/js/jquery-1.11.1.min.js"></script>
        <script src="/adminassets/js/bootstrap.min.js"></script>
        <script src="/adminassets/js/chart.min.js"></script>
        <script src="/adminassets/js/chart-data.js"></script>
        <script src="/adminassets/js/easypiechart.js"></script>
        <script src="/adminassets/js/easypiechart-data.js"></script>
